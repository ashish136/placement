      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <div class="row placeholders">
			...
			<form role="form" class="form-horizontal" action="/placement/Feedback" method="post">
				<div class="form-group">
					<label for="userid" class="control-label col-sm-2">Feedback:</label>
					<div class="col-sm-6">
						<input type = "text" class="form-control" id="feedback" placeholder="give your feedback" name="feedback">
					</div>
				</div>
