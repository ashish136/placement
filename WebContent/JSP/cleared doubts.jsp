...
<%! 
	...
	int passing_year, percentage,doubtid;
	long contact;
	ResultSet rs,rs2;
	%>
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <div class="row placeholders">
            ...
            <table class="table table-striped">
              ...
              <tbody>
              <tr><th>Subject</th><th>Doubt</th><th>Answer</th></tr>
              <% 
	HttpSession hs = request.getSession(false);
	uID = (String)hs.getAttribute("userid");
	System.out.println(uID);
Connection con = CrudOperation.createConnection();
	String strsql = "select * from doubts where status=true";
	try
	{
	...
	while(rs.next()){
		...
		doubtid = rs.getInt("doubtid");
		String strsql2 = "select * from ansdoubt where doubtid=?";
		ps.setInt(1, doubtid);
		rs2 = ps.executeQuery();
		%><tr><th><%=rs.getString("subject")%></th><th><%=rs.getString("doubt")%></th><th><%=rs2.getString("answer")%></th></tr><% 
