      ...
      <div class="row row-offcanvas row-offcanvas-left">
         ...
         <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
            ...
            <ul class="nav nav-sidebar">
              ...
              <li><a href="/placement/JSP/recuiter_edit_profile.jsp">EDIT PROFILE</a></li>
              <li><a href="/placement/JSP/post_job.jsp">POST JOBS</a></li>
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <div class="row placeholders">
           <div class = "container cont bg-1">
			<form role="form" class="form-horizontal" action="/placement/PostJob" method="post">
				...
				<div class="form-group">
					<label for="password" class="control-label col-sm-2">CRITERIA:</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="cri"  name="cri">
					</div>
				</div>
				<div class="form-group">
