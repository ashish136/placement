      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <div class="row placeholders">
			...
			<form role="form" class="form-horizontal" action="/placement/updatejobs" method="post">
			<div class="form-group">
					<label for="userid" class="control-label col-sm-2">job name:</label>
					<div class="col-sm-6">
						<input type = "text" class="form-control" id="userid" placeholder="Enter name" name="jobname">
					</div>
				</div>
				<div class="form-group">
					<label for="userid" class="control-label col-sm-2">Changed criteria:</label>
					<div class="col-sm-6">
						<input type = "text" class="form-control" id="userid" placeholder="Enter criteria" name="criteria">
					</div>
				</div>
