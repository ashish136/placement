        ...
        <div class="col-sm-9 col-md-10 main" style="width: 100%;">
          ...
          <div class="row placeholders">
			...
			<form action="/placement/Registration" method="post" role="form" class="form-horizontal">
				...
				<div class="form-group">
					<label for="owner" class="control-label col-sm-2">Owner Name:</label>
					<div class="col-sm-6">
						<input type = "text" class="form-control" id="owner_name" placeholder="Enter Owner Name" name="owner">
					</div>
				</div>
				
				<div class="form-group">
					<label for="url" class="control-label col-sm-2">Website URL:</label>
					<div class="col-sm-6">
