      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <div class="row placeholders">
			...
			<form role="form" class="form-horizontal" action="/placement/Doubts" method="post">
				<div class="form-group">
					<label for="userid" class="control-label col-sm-2">Subject</label>
					<div class="col-sm-6">
						<input type = "text" class="form-control" id="subject" placeholder="Enter subject" name="subject">
					</div>
				</div>
				<div class="form-group">
					<label for="password" class="control-label col-sm-2">Message</label>
					<div class="col-sm-6">
						<textarea rows="3" cols="21" name="message"></textarea>
					</div>
				</div>
