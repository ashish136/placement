...
<%! 
	String name, email, owner_name,website;
...
Connection con = CrudOperation.createConnection();
	String strsql = "select * from recuiter_detail where userid=?";
          ...
          <div class="row placeholders">
            ...
            <table class="table table-striped">
              ...
              <tbody>
               ...
               <tr><th>Owner Name :</th><th><%=owner_name%></th></tr>
               
               <tr><th>Website :</th><th><%=website%></th></tr>
